...
from aspire.utils.convertors import CONVERTOR_TYPES, Convertor
from aspire.utils.datastructures import URL, Headers, URLPath
from aspire.utils.exceptions import HTTPException
from aspire.utils.requests import Request
from aspire.utils.responses import PlainTextResponse, RedirectResponse
...
class Router:
    ...
    async def not_found(self, scope: Scope, receive: Receive, send: Send) -> None:
        ...
        # If we're running inside a aspire.utils application then raise an
