...
from aspire.utils.datastructures import State, URLPath
from aspire.utils.exceptions import ExceptionMiddleware
from aspire.utils.middleware import Middleware
from aspire.utils.middleware.base import BaseHTTPMiddleware
from aspire.utils.middleware.errors import ServerErrorMiddleware
from aspire.utils.routing import BaseRoute, Router
...
class Aspire:
    ...
    * **middleware** - A list of middleware to run for every request. A aspire.utils
    ...
    * **on_shutdown** - A list of callables to run on application shutdown.
    ...
    def __init__(
        ...
        lifespan: typing.Callable[["aspire.utils"], typing.AsyncGenerator] = None,
    ) -> None:
